...
const classes = computed(() => {
    return props.active
        ? 'block pl-3 pr-4 py-2 border-l-4 border-neutral-500 text-base font-medium text-neutral-800 bg-neutral-100 focus:outline-none focus:text-neutral-900 focus:bg-neutral-200 focus:border-neutral-800 transition'
