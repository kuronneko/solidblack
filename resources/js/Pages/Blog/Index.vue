                ...
                <div class="p-4 sm:px-6">
                    ...
                    <div class="py-3">
                        <div class='overflow-x-auto w-full'>
                            <table
                                class='mx-auto max-w-7xl w-full whitespace-nowrap rounded-lg bg-white dark:bg-neutral-900 divide-y divide-gray-300 dark:divide-neutral-900 overflow-hidden'>
                                <thead class="bg-gray-800 dark:bg-neutral-800">
                                    <tr class="text-gray-200 dark:text-gray-200 text-left">
                                        ...
                                        <th class="font-semibold text-sm uppercase px-6 py-4"> Categories </th>
                                ...
                                <tbody class="divide-y divide-gray-200 dark:divide-gray-700 dark:text-gray-200">
                                    <tr v-for="blog in blogs.data" :key="blog.id">
                                        ...
                                        <td class="px-6 py-4">
                                            <p class="truncate-words text-ellipsis overflow-hidden w-40"> {{ blog.name
                                                }} </p>
                                        </td>
                                        <td class="px-6 py-4">
                                            ...
                                            <div preserve-scroll v-else @click.once="toggleHighlight(blog)"
                                                for="checked-toggle"
                                                class="inline-flex relative items-center cursor-pointer">
                                        ...
                                        <td class="px-6 py-4">
                                            ...
                                            <div preserve-scroll v-else @click.once="toggleStatus(blog)"
                                                for="checked-toggle"
                                                class="inline-flex relative items-center cursor-pointer">
                                                <input type="checkbox" value="" id="checked-toggle" class="sr-only peer"
                                                    checked>
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex flex-wrap gap-2">
                                                <span v-for="category in blog.categories" :key="category.id" class="px-2 py-1 text-xs font-medium rounded-full
                             bg-gray-100 text-gray-800
                             dark:bg-neutral-700 dark:text-gray-200">
                                                    {{ category.name }}
                                                </span>
                                                <span v-if="blog.categories.length === 0"
